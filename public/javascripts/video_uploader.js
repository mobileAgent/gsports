...
GSports.SwfUpload = Class.create({
  initialize: function(vid,upload_url,file_types,file_size_limit,file_types_description,file_upload_limit){
...
//      },
      ...
      button_image_url: "/images/add_button.png",	// Relative to the Flash file
      button_width: "165",
      button_height: "29",
    ...
    try {
      ...
      switch (errorCode) {
        ...
        case SWFUpload.UPLOAD_ERROR.UPLOAD_STOPPED:
          break;
        default:
          debug="Error Code: " + errorCode + ", File name: " + file.name + ", File size: " + file.size + ", Message: " + message
          flasherror("An error occurred in the upload. Try again later.<br>"+debug);
          gs.video_assets.video_failed();
          this.swfu.debug(debug);
          return;
      }
